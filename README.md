...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/test1DataSource" pool-name="test1DataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/test1Database;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="test1SecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/test1DataSource"/>
